 ...
 */
// Create education
router.post("/", auth(ROLE.ADMIN), validateRequest(EducationValidation.createEducationValidationSchema), EducationController.createEducation);
// Update education
router.patch("/:id", auth(ROLE.ADMIN), validateRequest(EducationValidation.updateEducationValidationSchema), EducationController.updateEducation);
// Delete education
