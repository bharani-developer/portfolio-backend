...
import { EDUCATION_DEFAULT, EDUCATION_LEVEL, EDUCATION_TYPE, GRADE_TYPE, } from "./education.constant.js";
    ...
    await Education.insertMany([
        {
            ...
            grade: "Completed",
            description: "Completed pre-primary education and developed foundational learning, communication, and social skills.",
            achievements: [],
            skills: [],
            sortOrder: 1,
        ...
        },
        {
            ...
            gradeType: GRADE_TYPE.PASS,
            grade: "Completed",
            description: "Completed primary education with emphasis on mathematics, science, language, and general studies.",
            achievements: [],
            skills: [],
            sortOrder: 2,
            isActive: EDUCATION_DEFAULT.IS_ACTIVE,
        },
        {
            ...
            gradeType: GRADE_TYPE.PASS,
            grade: "Completed",
            description: "Completed middle school education with strong academic performance and participation in school activities.",
            achievements: [],
            skills: [],
            sortOrder: 3,
            isActive: EDUCATION_DEFAULT.IS_ACTIVE,
        ...
        },
        {
            ...
            gradeType: GRADE_TYPE.PERCENTAGE,
            grade: "First Class",
            description: "Studied Computer Science and Engineering with focus on software engineering, programming, databases, operating systems, networking, web technologies, and software development.",
            achievements: [
...
export const runEducationSeeder = async (standalone = false) => {
    try {
        if (standalone) {
...
//# sourceMappingURL=education.seeder.js.map