...
import { TESTIMONIAL_CLIENT_TYPE, TESTIMONIAL_DEFAULT, } from "./testimonials.constant.js";
    ...
    await Testimonial.insertMany([
        {
            ...
            review: "Placeholder testimonial. Replace this with an actual recommendation from your former manager or colleague.",
            rating: 5,
        ...
        },
        {
            ...
            review: "Placeholder testimonial. Replace this with a genuine recommendation received from your project manager or client.",
            rating: 5,
            clientType: TESTIMONIAL_CLIENT_TYPE.COMPANY,
            isFeatured: true,
            sortOrder: 2,
        ...
        },
        {
            ...
            review: "Placeholder testimonial. Replace this with a genuine testimonial from your technical lead, manager, or customer.",
            rating: 5,
            clientType: TESTIMONIAL_CLIENT_TYPE.COMPANY,
            isFeatured: true,
            sortOrder: 3,
        ...
        },
        {
            ...
            review: "Placeholder testimonial. Replace this with real feedback received from a freelance client after obtaining permission.",
            rating: 5,
        ...
        },
        {
            ...
            review: "Placeholder testimonial. Replace this with an actual LinkedIn recommendation after obtaining permission from the author.",
            rating: 5,
        ...
        },
        {
            ...
            review: "Placeholder testimonial. Replace this with a real appreciation email or customer feedback after obtaining permission.",
            rating: 5,
...
export const runTestimonialsSeeder = async (standalone = false) => {
    try {
        if (standalone) {
...
//# sourceMappingURL=testimonials.seeder.js.map