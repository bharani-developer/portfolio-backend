 ...
 */
// Create testimonial
router.post("/", auth(ROLE.ADMIN), validateRequest(TestimonialValidation.createTestimonialValidationSchema), TestimonialController.createTestimonial);
// Update testimonial
router.patch("/:id", auth(ROLE.ADMIN), validateRequest(TestimonialValidation.updateTestimonialValidationSchema), TestimonialController.updateTestimonial);
// Delete testimonial
router.delete("/:id", auth(ROLE.ADMIN), TestimonialController.deleteTestimonial);
export const TestimonialsRoutes = router;
//# sourceMappingURL=testimonials.route.js.map