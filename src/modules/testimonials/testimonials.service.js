...
const baseService = new BaseCrudService(Testimonial, [
...
const getTestimonialsByRating = async (rating) => {
    return Testimonial.find({
        rating,
        isActive: true,
    })
...
const getTestimonialsByClientType = async (clientType) => {
    return Testimonial.find({
        clientType,
        isActive: true,
    })
...
const getTestimonialsByProject = async (projectName) => {
    return Testimonial.find({
        projectName,
        isActive: true,
    })
