...
export type TTestimonialClientType =
  (typeof TESTIMONIAL_CLIENT_TYPE)[keyof typeof TESTIMONIAL_CLIENT_TYPE];
...
export type TCreateTestimonialPayload = Omit<
  ITestimonial,
  "createdAt" | "updatedAt"
>;

export type TUpdateTestimonialPayload = Partial<
  Omit<ITestimonial, "createdAt" | "updatedAt">
>;
