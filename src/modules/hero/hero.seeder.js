...
export const seedHero = async () => {
    ...
    await Hero.create({
        ...
        description: "I build scalable web and mobile applications using React, Next.js, Node.js, Express.js, Laravel, Flutter, TypeScript, MongoDB, and MySQL. With 8+ years of experience delivering enterprise applications, I specialize in creating secure, high-performance, and user-focused digital solutions.",
...
export const runHeroSeeder = async (standalone = false) => {
    try {
        if (standalone) {
...
//# sourceMappingURL=hero.seeder.js.map