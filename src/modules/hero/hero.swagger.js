    ...
    HeroImage: {
        ...
        properties: {
            url: {
                type: "string",
                format: "uri",
                example: "https://res.cloudinary.com/demo/image/upload/v1/portfolio/profile.jpg",
            },
            publicId: {
                type: "string",
    ...
    CreateHeroRequest: {
        ...
        properties: {
            ...
            description: {
                type: "string",
                maxLength: 1000,
                example: "Passionate Full Stack Developer building scalable web and mobile applications.",
            },
            profileImage: {
                $ref: "#/components/schemas/HeroImage",
            },
...
//# sourceMappingURL=hero.swagger.js.map