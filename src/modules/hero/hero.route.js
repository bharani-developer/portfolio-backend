...
router.post("/", auth(ROLE.ADMIN), validateRequest(HeroValidation.createHeroValidationSchema), HeroController.createHero);
router.patch("/", auth(ROLE.ADMIN), validateRequest(HeroValidation.updateHeroValidationSchema), HeroController.updateHero);
