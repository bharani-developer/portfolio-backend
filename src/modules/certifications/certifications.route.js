...
router.post("/", auth(ROLE.ADMIN), validateRequest(CertificationValidation.createCertificationValidationSchema), CertificationController.createCertification);
// Update certification
router.patch("/:id", auth(ROLE.ADMIN), validateRequest(CertificationValidation.updateCertificationValidationSchema), CertificationController.updateCertification);
// Delete certification
router.delete("/:id", auth(ROLE.ADMIN), CertificationController.deleteCertification);
export const CertificationsRoutes = router;
//# sourceMappingURL=certifications.route.js.map