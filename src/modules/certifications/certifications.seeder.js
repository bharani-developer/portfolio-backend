    ...
    await Certification.insertMany([
        {
            ...
            expiryDate: null,
            neverExpires: true,
            description: "Completed professional training in AutoCAD, Core Java, and C++ programming fundamentals.",
            skills: [
                "AutoCAD",
                "Java",
                "C++",
        ...
        },
        {
            ...
            expiryDate: null,
            neverExpires: true,
            description: "Successfully completed in-plant and corporate training focused on software development practices and real-world application development.",
            skills: [
        ...
        },
        {
            ...
            expiryDate: null,
            neverExpires: true,
            description: "Completed training covering networking fundamentals, switching, routing, and network infrastructure concepts.",
            skills: [
                "Networking",
                "Switching",
                "Routing",
        ...
        },
        {
            ...
            expiryDate: null,
            neverExpires: true,
            description: "Completed Android application development training covering mobile application fundamentals and Android development concepts.",
            skills: [
                "Android",
                "Mobile Development",
                "Java",
...
export const runCertificationsSeeder = async (standalone = false) => {
    try {
        if (standalone) {
...
//# sourceMappingURL=certifications.seeder.js.map