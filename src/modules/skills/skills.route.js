 ...
 * Protected Routes
 */
router.post("/", auth(ROLE.ADMIN), validateRequest(SkillsValidation.createSkillValidationSchema), SkillsController.createSkill);
router.patch("/:id", auth(ROLE.ADMIN), validateRequest(SkillsValidation.updateSkillValidationSchema), SkillsController.updateSkill);
