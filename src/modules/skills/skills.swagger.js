    ...
    Skill: {
        ...
        properties: {
            ...
            description: {
                ...
                example: "Building modern, scalable and high-performance user interfaces using React, TypeScript and the latest ecosystem.",
            },
            sortOrder: {
                type: "integer",
    ...
    UpdateSkillRequest: {
        ...
        properties: {
            ...
            description: {
                type: "string",
                maxLength: SKILLS_VALIDATION.DESCRIPTION.MAX_LENGTH,
                example: "Updated skill description for the latest technologies and frameworks.",
            },
            sortOrder: {
                type: "integer",
                minimum: SKILLS_VALIDATION.SORT_ORDER.MIN,
...
export const skillsPaths = {
    "/skills": {
        get: {
            ...
            description: "Retrieve a paginated list of skills with support for searching, filtering, sorting, pagination, and field selection.",
            parameters: [
                {
                    in: "query",
                    name: "searchTerm",
        ...
        post: {
            ...
            description: "Creates a new skill. Skill names must be unique. A slug is automatically generated from the skill name.",
            security: [
                {
                    bearerAuth: [],
                },
                        ...
                        examples: {
                            frontendSkill: {
                                ...
                                value: {
                                    ...
                                    description: "Building scalable component-based user interfaces with React and TypeScript.",
                                    sortOrder: 1,
                                    isActive: true,
                                },
                            },
                            backendSkill: {
                                ...
                                value: {
                                    ...
                                    description: "Developing scalable REST APIs using Express.js and TypeScript.",
                                    sortOrder: 2,
                                    isActive: true,
                                },
                            },
    ...
    "/skills/active": {
        get: {
            ...
            description: "Retrieve all active skills sorted by category and sort order.",
            responses: {
                200: {
                                        ...
                                        data: [
                                            {
                                                ...
                                                description: "Building scalable user interfaces with React.",
                                                sortOrder: 1,
                                                isActive: true,
                                                createdAt: "2026-06-26T08:30:00.000Z",
                                                updatedAt: "2026-06-26T08:30:00.000Z",
                                            },
                                            {
                                                ...
                                                description: "Developing production-grade React applications with Next.js.",
                                                sortOrder: 2,
                                                isActive: true,
                                                createdAt: "2026-06-26T08:30:00.000Z",
                                                updatedAt: "2026-06-26T08:30:00.000Z",
    ...
    "/skills/{id}": {
        ...
        patch: {
            ...
            description: "Update an existing skill. Only administrators are authorized to update skills.",
            security: [
                {
                    bearerAuth: [],
                },
                        ...
                        examples: {
                            updateSkill: {
                                value: {
                                    ...
                                    description: "Production-ready React framework for modern web applications.",
                                    sortOrder: 2,
                                    isActive: true,
                                },
                            },
        ...
        delete: {
            ...
            description: "Delete a skill by its MongoDB ObjectId. Only administrators are authorized to delete skills.",
            security: [
                {
                    bearerAuth: [],
                },
