  ...
  await Experience.insertMany([
    {
      ...
      employmentType: EMPLOYMENT_TYPE.ONSITE,

      workMode: WORK_MODE.FULL_TIME,
...

    {
      ...
      employmentType: EMPLOYMENT_TYPE.REMOTE,

      workMode: WORK_MODE.FREELANCE,
      ...
      technologies: ['PHP', 'Laravel', 'Laravel Blade', 'JavaScript', 'HTML', 'CSS', 'MySQL'],
...
export const runExperienceSeeder = async (standalone = false): Promise<void> => {
  try {
    if (standalone) {
