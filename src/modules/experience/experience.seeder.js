    ...
    await Experience.insertMany([
        {
            ...
            isCurrent: false,
            summary: "Worked as a Junior Engineer developing web applications, Chrome extensions, APIs, and enterprise solutions using PHP, Laravel, Angular, JavaScript, HTML, CSS, and MySQL.",
            responsibilities: [
        ...
        },
        {
            ...
            isCurrent: false,
            summary: "Developed enterprise web applications and Learning Management Systems (LMS) using Laravel, PHP, MySQL, JavaScript, HTML, and CSS.",
            responsibilities: [
        ...
        },
        {
            ...
            isCurrent: false,
            summary: "Worked as a Senior Engineer building enterprise web and mobile applications using Laravel, Flutter, JavaScript, MySQL, payment gateway integrations, Firebase, Google Maps, and third-party APIs.",
            responsibilities: [
...
export const runExperienceSeeder = async (standalone = false) => {
    try {
        if (standalone) {
