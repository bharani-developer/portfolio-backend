...
import { CONTACT_MESSAGE, CONTACT_PRIORITY, CONTACT_SEARCHABLE_FIELDS, CONTACT_STATUS, } from "./contact.constant.js";
import { Contact } from "./contact.model.js";
const baseService = new BaseCrudService(Contact, [
...
const getContactsByPriority = async (priority) => {
    return Contact.find({
        priority,
        isActive: true,
    })
