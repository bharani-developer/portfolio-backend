 ...
 */
// Create blog
router.post("/", auth(ROLE.ADMIN), validateRequest(BlogValidation.createBlogValidationSchema), BlogController.createBlog);
// Update blog
router.patch("/:id", auth(ROLE.ADMIN), validateRequest(BlogValidation.updateBlogValidationSchema), BlogController.updateBlog);
// Delete blog
