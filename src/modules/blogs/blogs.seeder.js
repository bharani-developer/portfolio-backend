    ...
    const blogs = [
        {
            ...
            slug: generateSlug("Building a Production Ready Portfolio Backend with Express and TypeScript"),
            excerpt: "Learn how to build a scalable portfolio backend using Express 5, TypeScript, MongoDB, Zod, and Mongoose.",
            content: `
...
This setup is highly scalable and production ready.
        `,
            ...
            seoDescription: "Build a scalable Express and TypeScript backend with MongoDB and modern best practices.",
        ...
        },
        {
            ...
            excerpt: "Improve MongoDB performance using indexes, aggregation pipelines, and query optimization strategies.",
            content: `
...
These practices help create scalable frontend applications.
        ...
        },
        {
            ...
            excerpt: "A structured roadmap covering frontend, backend, databases, DevOps, and deployment.",
            content: `
...
export const runBlogsSeeder = async (standalone = false) => {
    try {
        if (standalone) {
...
//# sourceMappingURL=blogs.seeder.js.map