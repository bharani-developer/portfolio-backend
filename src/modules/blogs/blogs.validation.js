...
import { z } from "zod";
import { BLOG_CATEGORIES, BLOG_DEFAULT, BLOG_STATUSES, BLOG_STATUS, } from "./blogs.constant.js";
...
const createBlogValidationSchema = z.object({
    body: z
        ...
        const isPublished = data.status === BLOG_STATUS.PUBLISHED || data.isPublished;
