 ...
 * Google Login
 */
router.post("/google", validateRequest(AuthValidation.googleLoginValidationSchema), AuthController.googleLogin);
/**
 ...
 * Change Password
 */
router.post("/change-password", auth(ROLE.ADMIN, ROLE.VIEWER), validateRequest(AuthValidation.changePasswordValidationSchema), AuthController.changePassword);
/**
 * Logout
 */
