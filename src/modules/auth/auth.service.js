...
import { comparePassword, generateAccessToken, generateRefreshToken, verifyToken, } from "../../helpers/index.js";
...
const changePassword = async (userId, payload) => {
    ...
    if (!user.password) {
        throw new AppError(httpStatus.BAD_REQUEST, AUTH_MESSAGE.INVALID_CREDENTIALS);
    }
