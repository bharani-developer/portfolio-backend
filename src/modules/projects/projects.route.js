 ...
 */
// Create project
router.post("/", auth(ROLE.ADMIN), validateRequest(ProjectValidation.createProjectValidationSchema), ProjectController.createProject);
// Update project
router.patch("/:id", auth(ROLE.ADMIN), validateRequest(ProjectValidation.updateProjectValidationSchema), ProjectController.updateProject);
// Delete project
