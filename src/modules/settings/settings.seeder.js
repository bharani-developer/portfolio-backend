...
export const seedSettings = async () => {
    ...
    await Settings.create({
        ...
        siteDescription: "Senior Software Engineer | Full Stack Developer specializing in React, Next.js, Node.js, Express.js, Laravel, Flutter, TypeScript, MongoDB, and MySQL.",
        ...
        seo: {
            ...
            metaDescription: "Portfolio of Bharani Karthikeyan, Senior Software Engineer and Full Stack Developer specializing in React, Next.js, Node.js, Express.js, Laravel, Flutter, TypeScript, MongoDB, and MySQL.",
            metaKeywords: [
                "Bharani Karthikeyan",
...
export const runSettingsSeeder = async (standalone = false) => {
    try {
        if (standalone) {
