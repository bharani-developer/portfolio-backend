...
const getDashboardStats = async (role) => {
    ...
    const [totalProjects, activeProjects, featuredProjects, totalBlogs, publishedBlogs, featuredBlogs, totalServices, activeServices, totalSkills, activeSkills, totalExperiences, currentExperiences, totalEducations, currentEducations, totalCertifications, activeCertifications, totalTestimonials, featuredTestimonials, totalContacts, unreadContacts, repliedContacts, heroExists, settingsExists, recentProjects, recentBlogs, recentContacts,] = await Promise.all([
