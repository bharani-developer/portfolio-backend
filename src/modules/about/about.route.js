...
router.post("/", auth(ROLE.ADMIN), validateRequest(AboutValidation.createAboutValidationSchema), AboutController.createAbout);
router.patch("/", auth(ROLE.ADMIN), validateRequest(AboutValidation.updateAboutValidationSchema), AboutController.updateAbout);
