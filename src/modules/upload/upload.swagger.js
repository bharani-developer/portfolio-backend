    ...
    UploadResponse: {
        ...
        properties: {
            url: {
                type: "string",
                format: "uri",
                example: "https://res.cloudinary.com/demo/image/upload/v1749999999/portfolio/profile.webp",
            },
            publicId: {
                type: "string",
...
export const uploadPaths = {
    "/upload/image": {
        post: {
            ...
            description: "Upload an image to Cloudinary and receive the uploaded image URL and public ID.",
            security: [
                {
                    bearerAuth: [],
                },
                        ...
                        schema: {
                            ...
                            properties: {
                                file: {
                                    type: "string",
                                    format: "binary",
                                    description: "Image file (jpeg, jpg, png, webp). Maximum size: 5 MB.",
                                },
                            },
                        },
                    },
...
//# sourceMappingURL=upload.swagger.js.map