...
export const servicesSchemas = {
    Service: {
        ...
        properties: {
            ...
            description: {
                type: "string",
                example: "Building scalable and responsive web applications using React, Node.js, TypeScript, Express, and MongoDB.",
            },
            icon: {
                type: "string",
                example: "code",
...
export const servicesPaths = {
    "/services": {
        get: {
            ...
            description: "Retrieve paginated services with search, filtering, sorting and field selection support.",
            parameters: [
                {
                    in: "query",
                    name: "searchTerm",
...
//# sourceMappingURL=services.swagger.js.map